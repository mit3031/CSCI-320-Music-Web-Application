...
"""
Starts SSH tunnel to the RIT database server
"""
def start_ssh():
    global server
...
"""
Returns the connection created by SSH tunnel
"""
def get_con():
    if server is None or not server.is_active:
...
"""
Utility function to generate random timestamp
"""
...
"""
Populates artist table with n unique artists
"""
...
"""
Populates genres table with n unique genres
"""
...
"""
Populates song table with n unique songs
"""
...
"""
Populates album table with n unique albums
"""
...
"""
Populates albums table with n unique albums containing songs
"""
def populate_albums(con, n=2000):
    cur = con.cursor()
    cur.execute("SELECT name FROM album")
...
"""
Populates collections table with n collections
"""
...
"""
Populates the followusers relationships table which connects which users follow which users
"""
...
"""
Populates the makesong relation table that connects artists to songs
"""
...
"""
Populates the makealbum relation table that connects artists and albums
"""
...
"""
Populates the ispartofalbum relation table which connects songs and albums
"""
...
"""
Populates the songhasgenre relation table which connects songs and genres
"""
...
"""
Populates the albumhasgenrerelation table which connects albums and genres
"""
...
"""
Synchronizes and fills in the missing information based on album-artist and album-genre relations
"""
def sync_music(con):
    cur = con.cursor()
...
"""
Populates the ispartofcollection relation table
"""
...
"""
Populates the listentosong relation table
"""
...
"""
Populates the songrating relation table
"""
